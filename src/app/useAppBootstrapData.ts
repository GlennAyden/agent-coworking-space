...
import type { Agent, CompanySettings, CompanyStats, Department, MeetingPresence, Project, SubTask, Task } from "../types";
...
export function useAppBootstrapData({
  ...
  const fetchAll = useCallback(async () => {
    try {
      ...
      const [depts, ags, tks, projectPage, sts, subs, presence, decisionItems] = await Promise.all([
