...
import { type AgentTravel } from "./office-view/agent-travel";
...
export default function OfficeView({
  ...
  const agentTravelAnimationsRef = useRef<AgentTravel[]>([]);
  ...
  const tickerContext = useMemo(
    () => ({
      ...
      dataRef,
      followCeoInView,
      onAgentTravelComplete: buildScene,
    }),
    [followCeoInView, cliUsageRef, buildScene],
  );
