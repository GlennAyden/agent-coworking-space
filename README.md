<p align="center">
  <img src="public/claw-empire.svg" width="80" alt="Agent Coworking Space" />
</p>

<h1 align="center">Agent Coworking Space</h1>
...
<p align="center">
  Agent Coworking Space is a fork and continuation of <a href="https://github.com/GreenSheep01201/claw-empire">Claw-Empire</a>. Credit and thanks to the original Claw-Empire project and contributors.
</p>

<p align="center">
  <img src="https://img.shields.io/badge/version-2.0.4-blue" alt="Releases" />
  <a href="https://github.com/GlennAyden/agent-coworking-space/actions/workflows/ci.yml"><img src="https://github.com/GlennAyden/agent-coworking-space/actions/workflows/ci.yml/badge.svg?branch=main" alt="CI" /></a>
...
>
> ```
> Install Agent Coworking Space following the guide at:
> https://github.com/GlennAyden/agent-coworking-space
> ```
>
...
You can run messenger channels directly from Agent Coworking Space without OpenClaw.
...
| Platform                 | Command                                                                                                                                |
| ------------------------ | -------------------------------------------------------------------------------------------------------------------------------------- |
| **macOS / Linux**        | `git clone https://github.com/GlennAyden/agent-coworking-space.git && cd agent-coworking-space && bash install.sh`                                    |
| **Windows (PowerShell)** | `git clone https://github.com/GlennAyden/agent-coworking-space.git; cd agent-coworking-space; powershell -ExecutionPolicy Bypass -File .\install.ps1` |
...
# 6. Setup AGENTS.md orchestration rules (teaches your AI agent to be an Agent Coworking Space project manager)
...
- Call the Agent Coworking Space REST API to create tasks, assign agents, and report status
...
When a chat message starts with `$`, Agent Coworking Space handles it as a CEO directive:
...
When a newer release is published on GitHub, Agent Coworking Space shows a top banner in the UI with pull instructions and a release-note link.
...
Agent Coworking Space is designed with security in mind:
...
_Agent Coworking Space — Where AI agents come to work. Based on Claw-Empire._
