...
const CLI_CHILD_ENV_STRIP_KEYS = [
  "API_AUTH_TOKEN",
  "APP_DATA_DIR",
  "CLAW_MIGRATION_V1_0_5_DONE",
  "CLAUDE_CODE",
  "CLAUDECODE",
  "HOST",
  "INBOX_WEBHOOK_SECRET",
  "MEETING_PROMPT_TASK_CONTEXT_MAX_CHARS",
  "MEETING_TRANSCRIPT_LINE_MAX_CHARS",
  "MEETING_TRANSCRIPT_MAX_TURNS",
  "MEETING_TRANSCRIPT_TOTAL_MAX_CHARS",
  "OAUTH_BASE_URL",
...
export function sanitizeCliChildEnv(env: NodeJS.ProcessEnv): NodeJS.ProcessEnv {
  const cleanEnv = { ...env };
  for (const key of CLI_CHILD_ENV_STRIP_KEYS) {
    delete cleanEnv[key];
  }
  return cleanEnv;
}
